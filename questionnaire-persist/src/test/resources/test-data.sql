INSERT INTO USER (name, password, auto_login, mobile, email, status, type, register_time, last_login_time, last_login_address, last_login_ip)
VALUES
...
VALUES
  (3, '3', '2015-10-29 7:34:23', '2015-10-29 7:34:23', 0, 2),
  (4, '4_1', '2015-10-20 9:34:23', '2015-10-29 15:34:23', 0, 2),
  (4, '4_2', '2015-11-29 20:34:23', '2015-11-29 10:34:23', 0, 0),
  (4, '4_3', '2015-10-14 7:44:23', '2015-10-20 19:34:23', 0, 0);

INSERT INTO page(survey_id, title, question, question_count, question_start_id, rank)
VALUES
  (2, '2_1', '2_1', 2, 1, 1),
  (2, '2_2', '2_2', 1, 2, 2),
  (1, '1_1', '1_1', 2, 1, 1),
